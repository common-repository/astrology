 ...
 */
namespace Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver;

use Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\AccessException;
use Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\InvalidArgumentException;
use Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\InvalidOptionsException;
use Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\MissingOptionsException;
use Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\NoSuchOptionException;
use Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\OptionDefinitionException;
use Prokerala\Astrology\Vendor\Symfony\Component\OptionsResolver\Exception\UndefinedOptionsException;
/**
        ...
        if (isset($this->allowedTypes[$option])) {
            ...
            if (!$valid) {
                ...
                $allowedContainsArrayType = \count(array_filter($this->allowedTypes[$option], static function ($item) {
                    return substr_compare($item, '[]', -strlen('[]')) === 0;
                })) > 0;
