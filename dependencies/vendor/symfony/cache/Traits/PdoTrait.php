...
use Prokerala\Astrology\Vendor\Doctrine\DBAL\Connection;
use Prokerala\Astrology\Vendor\Doctrine\DBAL\DBALException;
use Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use Prokerala\Astrology\Vendor\Doctrine\DBAL\DriverManager;
use Prokerala\Astrology\Vendor\Doctrine\DBAL\Exception;
use Prokerala\Astrology\Vendor\Doctrine\DBAL\Exception\TableNotFoundException;
use Prokerala\Astrology\Vendor\Doctrine\DBAL\ParameterType;
use Prokerala\Astrology\Vendor\Doctrine\DBAL\Schema\Schema;
use Prokerala\Astrology\Vendor\Doctrine\DBAL\Statement;
    ...
    private function getConnection()
    {
        ...
        if (null === $this->driver) {
            if ($this->conn instanceof \PDO) {
                ...
                switch (\true) {
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\Mysqli\Driver:
                        throw new \LogicException(sprintf('The adapter "%s" does not support the mysqli driver, use pdo_mysql instead.', static::class));
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\AbstractMySQLDriver:
                        $this->driver = 'mysql';
                        break;
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\PDOSqlite\Driver:
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\PDO\SQLite\Driver:
                        $this->driver = 'sqlite';
                        break;
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\PDOPgSql\Driver:
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\PDO\PgSQL\Driver:
                        $this->driver = 'pgsql';
                        break;
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\OCI8\Driver:
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\PDOOracle\Driver:
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\PDO\OCI\Driver:
                        $this->driver = 'oci';
                        break;
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\SQLSrv\Driver:
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\PDOSqlsrv\Driver:
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver\PDO\SQLSrv\Driver:
                        $this->driver = 'sqlsrv';
                        break;
                    case $driver instanceof \Prokerala\Astrology\Vendor\Doctrine\DBAL\Driver:
