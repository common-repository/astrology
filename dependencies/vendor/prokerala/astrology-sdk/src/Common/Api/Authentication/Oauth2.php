...
{
    use \Prokerala\Common\Api\Authentication\BasicAuthTrait;
    ...
    public function __construct(string $clientId, string $clientSecret, ClientInterface $httpClient, RequestFactoryInterface $httpRequestFactory, StreamFactoryInterface $streamFactory, ?CacheInterface $cache = null)
    {
    ...
    {
        ($nullsafeVariable1 = $this->cache) ? $nullsafeVariable1->delete(self::CACHE_KEY) : null;
