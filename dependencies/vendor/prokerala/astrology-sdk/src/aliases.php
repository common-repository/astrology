...
function addAlias()
{
    ...
    $classMap = ['AshtakavargaChartHouse', 'AshtakavargaChartHousePlanet', 'AshtakavargaPlanet', 'AshtakavargaPlanetResult', 'AshtakavargaRasiResult', 'AshtakavargaResult', 'Sarvashtakavarga', 'SarvashtakavargaResult'];
    foreach ($classMap as $class) {
        class_alias("{$newNamespace}\\{$class}", "{$oldNamespace}\\{$class}");
    }
}
addAlias();
class_alias("Prokerala\\Api\\Astrology\\Result\\Element\\Bhava", "Prokerala\\Api\\Astrology\\Result\\Horoscope\\Astagavarga\\Bhava");
