...
class PeriodCycleNumberResult implements ResultInterface
{
    ...
    /**
     * @var \Prokerala\Api\Numerology\Result\Pythagorean\Components\PeriodCycleNumber
     */
    private $periodCycleNumber;
    public function __construct(PeriodCycleNumber $periodCycleNumber)
    {
