...
class CompositeChart implements ResultInterface
{
     ...
     * @var PlanetAspect[]
     */
    private $compositeAspects;
    /**
     * @var PlanetPosition[]
     */
    private $compositeAngles;
    /**
     * @var House[]
     */
    private $compositeHouses;
    /**
     * @var PlanetPosition[]
     */
    private $compositePlanetPositions;
    /**
     ...
     */
    public function __construct(array $compositeHouses, array $compositePlanetPositions, array $compositeAngles, array $compositeAspects, string $transitDatetime)
    {
