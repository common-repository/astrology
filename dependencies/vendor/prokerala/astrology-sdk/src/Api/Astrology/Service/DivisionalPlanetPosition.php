...
final class DivisionalPlanetPosition
{
     ...
     * @var string
     */
    protected $slug = '/astrology/divisional-planet-position';
     ...
     **
     */
    public function process(Location $location, \DateTimeInterface $datetime, string $chartType, string $la = 'en'): DivisionalPlanetPositionResult
    {
        $parameters = ['datetime' => $datetime->format('c'), 'coordinates' => $location->getCoordinates(), 'ayanamsa' => $this->getAyanamsa(), 'chart_type' => $chartType, 'la' => $la];
