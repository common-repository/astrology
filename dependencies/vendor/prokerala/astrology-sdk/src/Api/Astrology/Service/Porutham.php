...
final class Porutham
{
    ...
    public function process(Profile $girl_profile, Profile $boy_profile, string $system, bool $detailed_report = \false, string $la = 'en')
    {
        ...
        $parameters = ['girl_coordinates' => $girl_location->getCoordinates(), 'girl_dob' => $girl_profile->getDateTime()->format('c'), 'boy_coordinates' => $boy_location->getCoordinates(), 'boy_dob' => $boy_profile->getDateTime()->format('c'), 'system' => $system, 'ayanamsa' => $this->getAyanamsa(), 'la' => $la];
