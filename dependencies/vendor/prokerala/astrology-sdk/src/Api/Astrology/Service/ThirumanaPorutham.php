...
final class ThirumanaPorutham
{
    ...
    public function process(NakshatraProfile $girl_profile, NakshatraProfile $boy_profile, bool $detailed_report = \false, string $la = 'en')
    {
        ...
        $parameters = ['girl_nakshatra' => $girl_profile->getNakshatra(), 'girl_nakshatra_pada' => $girl_profile->getNakshatraPada(), 'boy_nakshatra' => $boy_profile->getNakshatra(), 'boy_nakshatra_pada' => $boy_profile->getNakshatraPada(), 'la' => $la];
