...
use Prokerala\Api\Astrology\Result\Panchang\AnandadiYoga as AnandadiYogaResult;
...
final class AnandadiYoga
{
    ...
    public function __construct(Client $client)
    {
        ...
        $this->transformer = new Transformer(AnandadiYogaResult::class);
