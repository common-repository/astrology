...
use Prokerala\Api\Astrology\Result\Horoscope\VimsottariDasha as VimsottariDashaResult;
...
final class DashaPeriod
{
    ...
    public function __construct(Client $client)
    {
        ...
        $this->basicResponseTransformers = new Transformer(VimsottariDashaResult::class);
