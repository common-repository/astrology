...
final class AdvancedPanchang implements ResultInterface
{
     ...
     */
    public function __construct(string $vaara, array $nakshatra, array $tithi, array $karana, array $yoga, \DateTimeInterface $sunrise, \DateTimeInterface $sunset, \DateTimeInterface $moonrise, \DateTimeInterface $moonset, array $auspiciousPeriod, array $inauspiciousPeriod)
    {
        $this->vaara = $vaara;
