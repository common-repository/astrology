...
final class PlanetRelationship implements ResultInterface
{
    ...
    private $naturalRelationship;
    /** @var PlanetRelation[] $temporalRelationship */
    private $temporalRelationship;
    /** @var PlanetRelation[] $compoundRelationship */
    private $compoundRelationship;
    /**
     ...
     */
    public function __construct(array $naturalRelationship, array $temporalRelationship, array $compoundRelationship)
    {
