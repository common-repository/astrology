...
final class Koot
{
    ...
    {
        return ['varna' => $this->varna, 'vasya' => $this->vasya, 'tara' => $this->tara, 'yoni' => $this->yoni, 'grahaMaitri' => $this->grahaMaitri, 'gana' => $this->gana, 'bhakoot' => $this->bhakoot, 'nadi' => $this->nadi];
    }
}
