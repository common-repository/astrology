...
namespace Prokerala\Astrology\Vendor\Buzz\Configuration;
...
final class ParameterBag implements \IteratorAggregate, \Countable
{
    ...
    public function add(array $parameters = []): self
    {
        ...
        if (isset($this->parameters['curl']) && isset($parameters['curl']) && \is_array($this->parameters['curl']) && \is_array($parameters['curl'])) {
